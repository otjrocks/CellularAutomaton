...
public class LangtonsLoopsRules extends SimulationRules {
  ...
  public int getNextState(Cell cell, Grid grid) {
    ...
    StringBuilder stateKey = new StringBuilder(Arrays.toString(states));
    if (TRANSITIONS_MAP.containsKey(stateKey.toString())) {
      return TRANSITIONS_MAP.get(stateKey.toString());
    }
